...
public class InputHandler {
    ...
    public int getAircon() {
        ...
        while (true) {
            ...
            aircon = sc.nextInt();
            if (aircon == 1 || aircon == 2) return aircon;
            System.out.println("에어컨 선택이 잘못되었습니다.");
        }
    }
    ...
    public int getAudio() {
        ...
        while (true) {
            ...
            audio = sc.nextInt();
            if (audio == 1 || audio == 2) return audio;
            System.out.println("오디오 선택이 잘못되었습니다.");
        }
    }
    ...
    public int getAutoPilot() {
        ...
        while (true) {
            ...
            auto = sc.nextInt();
            if (auto == 1 || auto == 2) return auto;
            System.out.println("자율주행 선택이 잘못되었습니다.");
        }
    }
}
